package com.justsafe.libview.dialog;
...
public class TUIKitDialog {
    ...
    public TUIKitDialog builder() {
        ...
        mBackgroundLayout.setLayoutParams(new FrameLayout.LayoutParams((int) (Math.min(mDisplay.getWidth(),mDisplay.getHeight()) * dialogWidth), LayoutParams.WRAP_CONTENT));
        return this;
    }
    ...
    public TUIKitDialog appendTitle(@NonNull String title) {
        showTitle = true;
        String s = mTitleTv.getText().toString();
        mTitleTv.setText(s + title);
        return this;
    }

    public TUIKitDialog setTitleSize(@NonNull int title) {
        showTitle = true;
        mTitleTv.setTextSize(title);
        return this;
    }
