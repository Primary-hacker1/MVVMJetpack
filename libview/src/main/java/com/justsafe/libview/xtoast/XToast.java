package com.justsafe.libview.xtoast;
...
public class XToast<X extends XToast<?>> {
    ...
    private final String TAG = XToast.class.getName();
    ...
    public X setXY(float x, float y) {
        this.x = x;
        this.y = y;
        return (X) this;
    }
...
//                mWindowParams.x = (int) x - 600;
//                mWindowParams.y = (int) y - 400;
//            }
//        }
     ...
     * 设置文本icon1
     */
    public X setText1(int id, CharSequence text) {
        ((TextView) findViewById(id)).setText(text);
        return (X) this;
    }
     ...
     * 设置文本icon2
     */
    public X setText2(int id, CharSequence text) {
        ((TextView) findViewById(id)).setText(text);
        return (X) this;
    }
     ...
     * 设置文本icon3
     */
    public X setText3(int id, CharSequence text) {
        ((TextView) findViewById(id)).setText(text);
        return (X) this;
    }
